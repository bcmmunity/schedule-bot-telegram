...
namespace TelegrammAspMvcDotNetCoreBot.Controllers
{
	public static class ScheduleUpdateController
	{
		...
		public static void Update()
		{
            ...
            ExcelParserController.ReadXls("ИТАСУ");
            ExcelParserController.ReadXls("ИНМИН");
            ExcelParserController.ReadXlsx("МГИ");
            ExcelParserController.ReadXls("ЭУПП");
            ExcelParserController.ReadXls("ЭкоТех");
