...
namespace TelegrammAspMvcDotNetCoreBot.Logic.PythonLogic
{
    public static class PythonEngine
    {
        public static string Execute()
        {
            ...
            scope.SetVariable("x", 10); // This will be the name of the dictionary in python script, initialized with previously created .NET Dictionary10
            ...
            //return parameter;
            engine.ExecuteFile("E://PythonScripts/hello.py", scope);
            int z = (int)scope.GetVariable("z");
            return z.ToString();
        }
    }
}
